...
is_half = False
gpt_path = "pretrained_models/s1/GPT_80.ckpt"
sovits_path = "pretrained_models/s2/G_35000.pth"
...
def load__sovits_weights(sovits_path):
    ...
    hps = json.load(open("pretrained_models/s2/config.json"))
...
rate, wav = next(get_tts_wav("prompt.wav", None, "ru", "Буря мглою небо кроет вихри снежные крут+я.", "ru"))
scipy.io.wavfile.write(f"out.wav", rate, wav)
